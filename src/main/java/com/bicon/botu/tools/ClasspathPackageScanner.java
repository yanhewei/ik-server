...
public class ClasspathPackageScanner {
	...
	public final static Set<Class> classSet = Sets.newHashSet();
    ...
    public static void main(String[] args) throws Exception {
        ClasspathPackageScanner scan = new ClasspathPackageScanner("com.org.dao.dto");
       System.out.println(scan.getFullyQualifiedClassNameList().toString());
    }
